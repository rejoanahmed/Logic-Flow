...
const Home = () => {
  return (
    <main className='bg-slate-800' style={{ minHeight: 'calc(100vh - 64px)' }}>
        ...
        <div className='py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12'>
          ...
          >
            ...
            <span className='text-sm font-medium'>
              Logic Flow is out! See what&apos;s new
            </span>
            <svg
          ...
          <h1 className='mb-4 text-4xl font-extrabold tracking-tight leading-none text-orange-200 md:text-5xl lg:text-6xl'>
            We invest in the world’s potential
          </h1>
          <p className='mb-8 text-lg font-normal lg:text-xl sm:px-16 xl:px-48 text-gray-400'>
            Here at Logic Flow we focus on collaboration, technology, and
            innovation to unlock long-term value and drive economic growth.
          </p>
          <div className='flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4'>
            <CreateWorkspaceButton />
            <a
              href='#'
              className='inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center rounded-lg border border-orange-400 text-orange-400 hover:bg-gray-100'
            >
              <svg
          ...
          <div className='px-4 mx-auto text-center md:max-w-screen-md lg:max-w-screen-lg lg:px-36'>
            ...
            <div className='flex flex-wrap justify-center items-center mt-8 text-gray-500'>
              <a href='#' className='mr-5 mb-5 lg:mb-0 hover:text-orange-400'>
                <svg
                  className='h-8'
                  viewBox='0 0 132 29'
                  fill='none'
